package com.openclaw.integration.feishu;
...
import com.openclaw.service.webhook.WebhookRouterService;
 ...
 */
@Component
@ConditionalOnProperty(prefix = "openclaw.channel.feishu.long-connection", name = "enabled", havingValue = "true")
public class FeishuLongConnectionRunner implements ApplicationRunner, DisposableBean {
    ...
    private static final String MESSAGE_DEDUP_KEY_PREFIX = "openclaw:feishu:message:";
    ...
    public FeishuLongConnectionRunner(WebhookRouterService webhookRouterService,
                                      ...
                                      @Value("${openclaw.channel.feishu.app-id:}") String appId,
                                      @Value("${openclaw.channel.feishu.app-secret:}") String appSecret,
                                      @Value("${openclaw.channel.feishu.long-connection.domain:}") String domain,
                                      @Value("${openclaw.channel.feishu.verification-token:}") String verificationToken,
                                      @Value("${openclaw.channel.feishu.encrypt-key:}") String encryptKey,
                                      @Value("${openclaw.channel.feishu.long-connection.dedup-seconds:120}") long dedupSeconds) {
