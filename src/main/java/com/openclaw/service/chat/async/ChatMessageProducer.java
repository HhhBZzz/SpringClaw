...
public class ChatMessageProducer {
    ...
    public ChatMessageProducer(RabbitTemplate rabbitTemplate,
                               @Value("${openclaw.rabbitmq.chat-exchange:chat.exchange}") String exchange,
                               @Value("${openclaw.rabbitmq.request-routing-key:chat.request}") String requestRoutingKey,
                               @Value("${openclaw.rabbitmq.response-routing-key:chat.response}") String responseRoutingKey) {
