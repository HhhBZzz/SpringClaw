package com.openclaw.service.security;

import com.openclaw.common.exception.BusinessException;
import com.openclaw.service.security.impl.DefaultWebhookSecurityService;
...
class DefaultWebhookSecurityServiceTest {
    ...
    void shouldPassWhenSignatureIsValid() {
        ...
        headers.put("X-Openclaw-Timestamp", String.valueOf(ts));
        headers.put("X-Openclaw-Nonce", nonce);
        headers.put("X-Openclaw-Signature", sign);
    ...
    void shouldRejectWhenSignatureInvalid() {
        ...
        Map<String, String> headers = Map.of(
                "X-Openclaw-Timestamp", String.valueOf(ts),
                "X-Openclaw-Nonce", "nonce-x",
