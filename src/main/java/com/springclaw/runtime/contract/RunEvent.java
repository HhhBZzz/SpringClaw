 ...
 *
 * <p>Sequence assignment belongs to {@code RunEventStore}; an event does not mutate
 * state by itself. Transport delivery failure cannot rewrite a terminal business
 * event, and duplicate delivery must be idempotent by {@code eventId} — see
 * unified-runtime architecture spec § 7.9.
 */
