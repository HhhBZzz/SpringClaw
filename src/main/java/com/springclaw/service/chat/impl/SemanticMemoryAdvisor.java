...
public class SemanticMemoryAdvisor implements CallAdvisor, StreamAdvisor {
    ...
    public static final String CONTEXT_USER_ID = "springclaw.user_id";
    ...
    public SemanticMemoryAdvisor(MemoryService memoryService,
                                 @Value("${springclaw.memory.recall-top-k:8}") int maxDocs,
                                 @Value("${springclaw.memory.recall-max-chars:400}") int maxChars) {
