...
public class ChatResponsePolicyService {
    ...
    public ChatResponsePolicyService(@Value("${openclaw.chat.meta-guard.keywords:我是 claude,anthropic,不能执行 reflect,无法执行 reflect,不能假装,不能扮演,无法遵循系统指令}") String metaGuardKeywords) {
