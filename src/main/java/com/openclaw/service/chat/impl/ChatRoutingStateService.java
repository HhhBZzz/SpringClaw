...
public class ChatRoutingStateService {
    ...
    public ChatRoutingStateService(@Autowired(required = false) StringRedisTemplate redisTemplate,
                                   ...
                                   @Value("${openclaw.chat.routing.redis-enabled:true}") boolean redisEnabled,
                                   @Value("${openclaw.chat.routing.redis-mode-key:openclaw:chat:routing:mode}") String redisModeKey,
                                   @Value("${openclaw.chat.routing.redis-auto-upgrade-key:openclaw:chat:routing:auto-upgrade}") String redisAutoUpgradeKey,
                                   @Value("${openclaw.chat.routing.audit-session-key:system:chat:routing}") String auditSessionKey) {
