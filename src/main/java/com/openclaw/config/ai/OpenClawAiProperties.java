 ...
 * OpenClaw 多模型接入配置。
 */
@ConfigurationProperties(prefix = "openclaw.ai")
public class OpenClawAiProperties {
    ...
    public static class State {
        ...
        private String redisKey = "openclaw:ai:active-provider";
        private String redisModelPrefix = "openclaw:ai:model:";
