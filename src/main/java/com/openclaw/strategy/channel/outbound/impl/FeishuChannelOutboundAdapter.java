package com.openclaw.strategy.channel.outbound.impl;
...
import com.openclaw.strategy.channel.outbound.ChannelOutboundAdapter;
...
public class FeishuChannelOutboundAdapter implements ChannelOutboundAdapter {
    ...
    public FeishuChannelOutboundAdapter(ObjectMapper objectMapper,
                                        @Value("${openclaw.channel.feishu.outbound-enabled:false}") boolean enabled,
                                        @Value("${openclaw.channel.feishu.base-url:https://open.feishu.cn}") String baseUrl,
