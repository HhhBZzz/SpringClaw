...
import com.openclaw.service.chat.ConversationEventTextSupport;
...
public class ContextAssembler {
    ...
    public ContextAssembler(MessageEventService messageEventService,
                            ...
                            @Value("${openclaw.chat.memory-window-size:8}") int memoryWindowSize,
                            @Value("${openclaw.memory.recall-top-k:8}") int recallTopK,
                            @Value("${openclaw.memory.recall-max-chars:400}") int recallMaxChars) {
