...
import com.openclaw.service.auth.ToolPermissionService;
...
public class ToolPermissionServiceImpl implements ToolPermissionService {
    ...
    public ToolPermissionServiceImpl(ToolPermissionMapper toolPermissionMapper,
                                     ...
                                     @Value("${openclaw.auth.tool-permission-enabled:true}") boolean permissionEnabled,
                                     @Value("${openclaw.persistence.db-enabled:false}") boolean dbEnabled,
                                     @Value("${openclaw.auth.default-deny:false}") boolean defaultDeny,
                                     @Value("${openclaw.auth.user-deny-tools:SystemToolPack.runCommand}") String userDenyTools,
                                     @Value("${openclaw.auth.guest-allow-tools:SystemToolPack.now,SystemToolPack.uuid}") String guestAllowTools) {
