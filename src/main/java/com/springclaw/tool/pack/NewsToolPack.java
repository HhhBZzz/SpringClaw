...
public class NewsToolPack {
    ...
    @Autowired
    public NewsToolPack(@Value("${springclaw.tools.news.enabled:true}") boolean enabled,
                        @Value("${springclaw.tools.news.search-url-template:https://hn.algolia.com/api/v1/search?query={query}&tags=story}") String searchUrlTemplate,
                        @Value("${springclaw.tools.news.max-items:5}") int maxItems,
                        @Value("${springclaw.tools.news.timeout-seconds:8}") int timeoutSeconds,
