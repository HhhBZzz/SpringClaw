package com.openclaw.service.session.impl;

import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.openclaw.domain.entity.AgentSession;
import com.openclaw.mapper.AgentSessionMapper;
...
public class AgentSessionServiceImpl extends ServiceImpl<AgentSessionMapper, AgentSession>
    ...
    public AgentSessionServiceImpl(@Value("${openclaw.persistence.db-enabled:false}") boolean dbEnabled) {
