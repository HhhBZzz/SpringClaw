...
3. 让 Obsidian / Wiki.js 这类 Markdown 知识源继续走受控 Knowledge Source review/list、snapshot preview、人工 status 治理或上下文注入点，而不是污染用户长期记忆。
