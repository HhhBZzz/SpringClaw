...
public class RabbitMQController {
    ...
    public RabbitMQController(RabbitAdmin rabbitAdmin,
                              @Value("${springclaw.rabbitmq.chat-request-queue:chat.request.queue}") String requestQueue,
                              @Value("${springclaw.rabbitmq.chat-response-queue:chat.response.queue}") String responseQueue,
                              @Value("${springclaw.rabbitmq.chat-dead-letter-queue:chat.dead-letter.queue}") String deadLetterQueue) {
